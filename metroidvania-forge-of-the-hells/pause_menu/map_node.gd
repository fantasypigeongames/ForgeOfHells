...
func _ready () -> void: 
	if Engine.is_editor_hint():
		...
		#check if section has been discovered by player 
...
func update_node() -> void: #should only be called in the editor, ResourceLoader is heavy
...
func display_player_location() -> void:
	...
	var i : Control = %PlayerIndicator #$"../PlayerIndictor"
